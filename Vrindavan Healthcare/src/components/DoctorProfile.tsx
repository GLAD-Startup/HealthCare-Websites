      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center p-5 sm:p-10 lg:p-12">
            ...
            <div className="lg:col-span-5 flex flex-col items-center">
              <div className="relative w-56 sm:w-72 h-72 sm:h-92 rounded-3xl overflow-hidden shadow-2xl border-4 border-[#F0FDFA] bg-slate-100 group">
                ...
                <div className="absolute bottom-3 left-3 right-3 p-2 bg-slate-900/60 backdrop-blur-md rounded-xl text-center text-white border border-white/20">
                  <div className="text-xs font-bold text-teal-300">MD (2018) • DM (Gastroenterology)</div>
                  <div className="text-[10px] text-slate-300">SRMS IMS Bareilly</div>
                </div>
              </div>

              {/* Justdial & Rating Bar */}
              <div className="mt-4 flex items-center gap-3 py-2 px-4 rounded-full bg-[#F0FDFA] border border-[#CCFBF1]">
                <div className="flex items-center text-[#F59E0B]">
                  <Star className="w-4 h-4 fill-current" />
                  <span className="font-extrabold text-slate-900 text-xs ml-1">4.5 / 5</span>
                </div>
                <span className="text-slate-400">|</span>
                <span className="text-xs text-slate-600 font-semibold">65+ Justdial Ratings</span>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#F0FDFA] text-[#0F766E] text-xs font-bold uppercase tracking-wider mb-2">
                ...
                <div className="text-[#0F766E] font-bold text-base sm:text-lg mt-1">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 border-l-4 border-[#0F766E] text-xs text-slate-700 italic space-y-1">
                <div className="flex items-center gap-1.5 font-bold text-slate-900 not-italic">
              ...
              <div className="p-3.5 rounded-2xl bg-[#F0FDFA] border border-[#CCFBF1] text-xs space-y-1">
        ...
        <div className="mt-10 max-w-5xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs font-semibold text-[#0F766E] bg-[#F0FDFA] px-3 py-1 rounded-full border border-[#CCFBF1]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="group rounded-2xl overflow-hidden bg-white border border-slate-200 shadow-sm hover:shadow-md transition-all">
            ...
            <div className="group rounded-2xl overflow-hidden bg-white border border-slate-200 shadow-sm hover:shadow-md transition-all">
              <div className="aspect-4/3 overflow-hidden bg-slate-100 relative">
                <img
                  ...
                  className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
                />
                <span className="absolute bottom-2 left-2 px-2 py-0.5 rounded-md bg-emerald-600/90 text-white text-[10px] font-bold">
                  Endoscopy Suite
                </span>
              </div>
              <div className="p-3.5">
            ...
            <div className="group rounded-2xl overflow-hidden bg-white border border-slate-200 shadow-sm hover:shadow-md transition-all">
              <div className="aspect-4/3 overflow-hidden bg-slate-100 relative">
                <img
                  ...
                  className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
                />
                <span className="absolute bottom-2 left-2 px-2 py-0.5 rounded-md bg-blue-600/90 text-white text-[10px] font-bold">
                  ERCP &amp; OT
                </span>
              </div>
              <div className="p-3.5">
