...
import { Calendar, Stethoscope, Star, Users, Search, Activity } from 'lucide-react';
  ...
  return (
    <section id="hero" className="pt-24 sm:pt-28 md:pt-36 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="relative rounded-3xl lg:rounded-[36px] bg-[#F0FDFA] border border-[#CCFBF1] p-6 sm:p-10 lg:p-14 overflow-hidden shadow-xs">
        ...
        <div className="absolute -top-20 -left-20 w-96 h-96 bg-white/70 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute -bottom-20 -right-20 w-[420px] h-[420px] bg-[#0F766E]/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-8 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            {/* Tag Badge */}
            <div className="hero-anime-item inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/95 backdrop-blur-md shadow-xs border border-teal-200/80 text-[#0F766E] text-xs sm:text-sm font-bold">
              <Activity className="w-4 h-4 text-[#0F766E]" />
              <span>Super-Specialty Gastro &amp; Liver Clinic • Vrindavan</span>
            </div>
            ...
            <div className="hero-anime-item pt-4 flex items-center gap-2 text-xs sm:text-sm font-semibold text-slate-700">
              ...
              <span className="text-slate-500 font-medium">Based On 65+ Verified Patient Ratings</span>
            </div>
          ...
          <div className="lg:col-span-5 relative flex items-center justify-center">
            <div className="relative w-full max-w-md lg:max-w-none flex justify-center items-center">
              ...
              {/* Main Doctor Frame */}
              <div className="hero-doctor-frame relative w-[280px] sm:w-[340px] h-[380px] sm:h-[450px] rounded-3xl overflow-hidden shadow-2xl bg-white border-4 border-white transition-transform duration-300 hover:scale-[1.02]">
                <img
                ...
                <div className="absolute top-3 right-3 bg-emerald-600/90 text-white backdrop-blur-md px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider shadow-md border border-white/20 flex items-center gap-1.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-white animate-pulse" />
                  <span>ERCP &amp; Endoscopy OT</span>
                </div>

                <div className="absolute bottom-3 left-3 right-3 text-white p-2.5 text-center bg-slate-900/75 backdrop-blur-md rounded-xl border border-white/20">
                  <div className="text-sm font-bold">Dr. Chaitanya Gupta</div>
                  <div className="text-[11px] text-teal-200 font-semibold">MBBS, MD (2018), DM (Gastroenterology)</div>
                  <div className="text-[10px] text-emerald-300 font-medium mt-0.5">Advanced ERCP &amp; Upper GI Endoscopy • ₹200 Fee</div>
                </div>
              </div>

              {/* Floating Badge 1: Top Left Experience */}
              <div ref={badge1Ref} className="absolute top-6 -left-2 sm:-left-6 bg-white/95 backdrop-blur-md py-2 px-3.5 rounded-2xl shadow-xl border border-slate-100 flex items-center gap-3 z-20">
                <div className="w-11 h-11 rounded-full overflow-hidden border-2 border-[#0F766E] shrink-0 shadow-sm bg-slate-100">
                  <img
                ...
                <div>
                  <div className="text-[12px] font-extrabold text-slate-900 leading-tight">
                    Dr. Chaitanya Gupta
                  </div>
                  <div className="text-[10px] text-[#0F766E] font-bold">
                    DM Gastroenterology
                  </div>
                </div>
              </div>
              ...
              <div ref={badge2Ref} className="absolute bottom-16 -right-2 sm:-right-6 bg-white/95 backdrop-blur-md py-2.5 px-4 rounded-2xl shadow-xl border border-slate-100 flex items-center gap-3">
                ...
                <div>
                  <div ref={countRef} className="text-base font-extrabold text-slate-900 leading-none">65+</div>
                  <div className="text-[11px] text-slate-500 font-medium mt-0.5">Verified Reviews (4.5★)</div>
                </div>
              </div>
          ...
          <form onSubmit={handleSearch} className="max-w-3xl mx-auto relative">
            <div className="relative flex items-center bg-white rounded-2xl shadow-lg border border-slate-200/90 p-1.5 focus-within:ring-2 focus-within:ring-[#0F766E]/30 focus-within:border-[#0F766E] transition-all">
              ...
              <input
                ...
                placeholder="Search for Endoscopy, Fatty Liver, Acidity, Ulcers, Diabetes..."
