...
import { Activity, Phone, Clock, ArrowUp, MessageSquare, Award } from 'lucide-react';
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3">
              <a
                ...
                className="px-5 py-2.5 rounded-full bg-[#0F766E] text-white hover:bg-[#0D9488] text-xs font-bold flex items-center gap-2 transition-all cursor-pointer"
              >
              ...
              <a
                ...
                className="px-5 py-2.5 rounded-full bg-emerald-600 text-white hover:bg-emerald-700 text-xs font-bold flex items-center gap-2 transition-all cursor-pointer"
              >
            ...
            <div className="pt-2 flex items-center gap-3 text-slate-400 text-xs">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-lg bg-slate-800 hover:bg-[#0F766E] hover:text-white transition-colors"
